...
const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onExampleClick, isDarkMode }) => {
  const examples = [
    {
      category: 'Math',
    ...
    },
    {
      ...
      color: isDarkMode 
        ? 'border-green-600 bg-green-900/30 hover:bg-green-800/40' 
        : 'border-green-200 bg-green-50 hover:bg-green-100',
      examples: [
        "What is the speed of light?",
        "Calculate kinetic energy with mass=5kg, velocity=10m/s",
    ...
    },
    {
      ...
      color: isDarkMode 
        ? 'border-purple-600 bg-purple-900/30 hover:bg-purple-800/40' 
    ...
    <div className="text-center py-8 px-4 max-w-4xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className={`text-lg max-w-2xl mx-auto leading-relaxed ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
          Your intelligent multi-agent assistant for math, physics, and general learning. 
          Powered by advanced AI with specialized tools and real-time problem solving.
        </p>
      </div>
